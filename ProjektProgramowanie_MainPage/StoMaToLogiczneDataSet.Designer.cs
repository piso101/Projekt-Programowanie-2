...
namespace ProjektProgramowanie_MainPage {
    ...
    public partial class StoMaToLogiczneDataSet : global::System.Data.DataSet {
        ...
        public partial class doctorDataTable : global::System.Data.TypedTableBase<doctorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public doctorRow AdddoctorRow(int id, string first_name, string last_name, string email, string phone, string specialization, string city) {
            ...
            public string city {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'city\' w tabeli \'doctor\' to DBNull.", e);
                    }
                }
                set {
...
namespace ProjektProgramowanie_MainPage.StoMaToLogiczneDataSetTableAdapters {
    ...
    public partial class doctorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[doctor] ([id], [first_name], [last_name], [email], [phone], [specialization], [city]) VALUES (@id, @first_name, @last_name, @email, @phone, @specialization, @city);
SELECT id, first_name, last_name, email, phone, specialization, city FROM doctor WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[doctor] SET [id] = @id, [first_name] = @first_name, [last_name] = @last_name, [email] = @email, [phone] = @phone, [specialization] = @specialization, [city] = @city WHERE (([id] = @Original_id) AND ((@IsNull_first_name = 1 AND [first_name] IS NULL) OR ([first_name] = @Original_first_name)) AND ((@IsNull_last_name = 1 AND [last_name] IS NULL) OR ([last_name] = @Original_last_name)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_specialization = 1 AND [specialization] IS NULL) OR ([specialization] = @Original_specialization)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)));
SELECT id, first_name, last_name, email, phone, specialization, city FROM doctor WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProjektProgramowanie_MainPage.Properties.Settings.Default.StoMaToLogiczneConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, first_name, last_name, email, phone, specialization, city FROM dbo.doc" +
                "tor";
        ...
        public virtual int Delete(int Original_id, string Original_first_name, string Original_last_name, string Original_email, string Original_phone, string Original_specialization, string Original_city) {
        ...
        public virtual int Insert(int id, string first_name, string last_name, string email, string phone, string specialization, string city) {
        ...
        public virtual int Update(int id, string first_name, string last_name, string email, string phone, string specialization, string city, int Original_id, string Original_first_name, string Original_last_name, string Original_email, string Original_phone, string Original_specialization, string Original_city) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string first_name, string last_name, string email, string phone, string specialization, string city, int Original_id, string Original_first_name, string Original_last_name, string Original_email, string Original_phone, string Original_specialization, string Original_city) {
            return this.Update(Original_id, first_name, last_name, email, phone, specialization, city, Original_id, Original_first_name, Original_last_name, Original_email, Original_phone, Original_specialization, Original_city);
        }
    }
